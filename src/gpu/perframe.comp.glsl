...
void main() {
    ...
    THREAD_POOL.total_jobs_ran += THREAD_POOL.work_items_l0_completed + THREAD_POOL.work_items_l1_completed;
    ...
    // clang-format off
    THREAD_POOL.work_items_l0_begin    += THREAD_POOL.work_items_l0_completed;
    THREAD_POOL.work_items_l0_queued   -= THREAD_POOL.work_items_l0_completed;
    THREAD_POOL.work_items_l0_begin     = THREAD_POOL.work_items_l0_begin % (MAX_CHUNK_WORK_ITEMS_L0 + 0);
    THREAD_POOL.work_items_l0_completed = 0;

    THREAD_POOL.work_items_l1_begin    += THREAD_POOL.work_items_l1_completed;
    THREAD_POOL.work_items_l1_queued   -= THREAD_POOL.work_items_l1_completed;
    THREAD_POOL.work_items_l1_begin     = THREAD_POOL.work_items_l1_begin % (MAX_CHUNK_WORK_ITEMS_L1 + 0);
