...
#define RESTIR_USE_SPATIAL 1
#define RESTIR_TEMPORAL_USE_PERMUTATIONS 1
#define RESTIR_USE_PATH_VALIDATION 1

// Narrow down the spatial resampling kernel when M is already high.
#define RTDGI_RESTIR_SPATIAL_USE_KERNEL_NARROWING 1

#define RTDGI_RESTIR_SPATIAL_USE_RAYMARCH 1
#define RTDGI_RESTIR_SPATIAL_USE_RAYMARCH_COLOR_BOUNCE 0
#define RTDGI_RESTIR_USE_JACOBIAN_BASED_REJECTION 0
