...
TraceResult do_the_thing(u32vec2 px, f32vec3 normal_ws, inout uint rng, RayDesc outgoing_ray) {
    ...
    VoxelTraceResult trace_result = trace_hierarchy_traversal(VoxelTraceInfo(voxel_malloc_page_allocator, voxel_chunks, chunk_n, outgoing_ray.Direction, MAX_STEPS, outgoing_ray.TMax, 0.0, true), ray_pos);
