...
DAXA_INL_TASK_USE_BEGIN(ChunkEditComputeUses, DAXA_CBUFFER_SLOT0)
...
DAXA_INL_TASK_USE_BUFFER(temp_voxel_chunks, daxa_RWBufferPtr(TempVoxelChunk), COMPUTE_SHADER_READ_WRITE)
