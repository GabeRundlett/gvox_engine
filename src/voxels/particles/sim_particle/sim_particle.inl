...
DAXA_DECL_TASK_HEAD_BEGIN(SimParticleSimCompute, 5 + VOXEL_BUFFER_USE_N)
...
struct SimParticles {
    ...
    void render_cubes(GpuContext &gpu_context, GbufferDepth &gbuffer_depth, daxa::TaskImageView velocity_image, daxa::TaskBufferView particles_state, daxa::TaskBufferView cube_index_buffer) {
    ...
    void render_splats(GpuContext &gpu_context, GbufferDepth &gbuffer_depth, daxa::TaskImageView velocity_image, daxa::TaskBufferView particles_state) {
