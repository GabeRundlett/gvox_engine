...
struct SkyRenderer {
    ...
    void generate_procedural_sky(GpuContext &gpu_context) {
        auto multiscattering_lut = sky_render_task_graph.create_task_image({
        ...
        gpu_context.add(ComputeTask<SkyAeCompute::Info, SkyAeComputePush, NoTaskInfo>{
            ...
            .views = SkyAeCompute::Views{
                ...
                .transmittance_lut = transmittance_lut.task_resource.view(),
                .multiscattering_lut = multiscattering_lut,
                .aerial_perspective_lut = aerial_perspective_lut.task_resource.view(),
            },
