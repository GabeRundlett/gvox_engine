...
inline void convolve_cube(RecordContext &record_ctx, daxa::TaskImageView sky_lut, daxa::TaskImageView transmittance_lut, daxa::TaskImageView output_cube) {
    record_ctx.add(ComputeTask<ConvolveCubeCompute, ConvolveCubeComputePush, NoTaskInfo>{
        ...
        .views = std::array{
            ...
            daxa::TaskViewVariant{std::pair{ConvolveCubeCompute::sky_lut, sky_lut}},
            daxa::TaskViewVariant{std::pair{ConvolveCubeCompute::transmittance_lut, transmittance_lut}},
