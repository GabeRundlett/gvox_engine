...
#define KEYBINDS_MOVE_R GLFW_KEY_D
#define KEYBINDS_MOVE_L GLFW_KEY_A
#define KEYBINDS_MOVE_D GLFW_KEY_LEFT_CONTROL
#define KEYBINDS_MOVE_U GLFW_KEY_SPACE
#define KEYBINDS_MOVE_B GLFW_KEY_S
#define KEYBINDS_MOVE_F GLFW_KEY_W
#define KEYBINDS_SPRINT GLFW_KEY_LEFT_SHIFT
#define KEYBINDS_NOCLIP GLFW_KEY_F
